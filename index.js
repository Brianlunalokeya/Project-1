...
mealList.addEventListener('click', getMeMealRecipe);
recipeCloseBtn.addEventListener('click', () => {
    mealDetailsContent.parentElement.classList.remove('showRecipe');
})

//get meal list that matches with ingredients
function getMeMealList(){
    ...
    .then(data => {
        ...
        if(data.meals){
            data.meals.forEach(meal => {
                ...
                <div class= "meal-img">
                                <img src="${meal.strMealThumb}" alt="food" id="food-image">
                            </div>
                            <div class="meal-name">
                            <h3>meal.strMeal</h3>
